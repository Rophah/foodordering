...
<div class="container">
	...
	<table class="table table-striped mt-5">
		...
		?>		<tr>
				...
				<td>
					<input type="button" name="deletetry" onclick="deletetry(<?php echo $value['cart_id']?>)" value="delete">
				</td>
				</tr>
		<?php }?>
...
<script type="text/javascript">
	...
	function deletetry(del_id){
		window.location.href = "deletetry.php?del=" + del_id;
	}
</script>