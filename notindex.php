			...
			<div class="row">
				<div class="col words">
					<div class="maintext text-center text-light">
						<h1 class="hungry display-3">HUNGRY?</h1>
						<H2 class="hungrytext">Good, we are here to serve <span>YOU<span></H2>
						<h3 class="hungrytext">Order from us where you get treated as a king</h3>
...
<section id="ourstory">
		...
		<div class="container" >	
			...
			<div class="row p-5 ">
				<div class="col-sm-12 col-md-4 text-center">
					<img src="images/fufuandogbono.jpg" class="img-fluid">
					<h5 class="text-center text-bold py-3">Local Dishes</h5>
					<a href="#" class="btn btnsecondary">View more</a>
				</div>
				<div class="col-sm-12 col-md-4 text-center">
					<img src="images/jollofrice.jpg" class="img-fluid">
					<h5 class=" py-3">Intercontinental Dishes</h5>
				
					<a href="#" class="btn btnsecondary">View more</a>
				</div>
				<div class="col-sm-12 col-md-4 text-center">
					<img src="images/meatpie.jpg" class="img-fluid">
					<h5 class="text-center py-3">Snacks</h5>
					<a href="#" class="btn btnsecondary">View more</a>
				</div>
			</div>
		</div>
	...
	<div id="menubackground">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="text-center py-3 text-uppercase">Popular dishes</h2>
					<div class="underline underlinewider"></div>
				</div>
			</div>
			<div class="row p-4">
